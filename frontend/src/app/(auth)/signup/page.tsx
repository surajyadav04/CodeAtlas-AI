  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#0C0A09]">
      <div className="w-full max-w-md p-8 bg-[#121110] border border-[#2C2825] rounded-xl shadow-xl">
        <h1 className="text-2xl font-bold text-[#F3E4C9] mb-6 text-center">Create an Account</h1>
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-[#A77F60] mb-1">Name</label>
            <input
              type="text"
              value={name}
        ...
        <p className="mt-6 text-center text-sm text-[#8e9289]">
          ...
          <Link href="/login" className="text-[#A77F60] hover:text-[#F3E4C9] transition-colors">
            Sign in
          </Link>
        </p>
      </div>
